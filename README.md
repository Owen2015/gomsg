...
2. Enter go workspace and using "go install yourpackagepath/gomsg" to install it.
3. Now there should be a gomsg executable file in you bin folder. Using "./bin/gomsg" to run it
4. Open browser and enter "http://localhost:3000/" and you can access the stock data in real time.
